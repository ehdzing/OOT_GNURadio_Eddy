#ifndef INCLUDED_HOWTO_FLEX_FIR_CF_H
#define INCLUDED_HOWTO_FLEX_FIR_CF_H
...
class HOWTO_API flex_fir_cf : virtual public gr::sync_block
{
public:
  typedef boost::shared_ptr<flex_fir_cf> sptr;
