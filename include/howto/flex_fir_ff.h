#ifndef INCLUDED_HOWTO_FLEX_FIR_FF_H
#define INCLUDED_HOWTO_FLEX_FIR_FF_H
...
class HOWTO_API flex_fir_ff : virtual public gr::sync_block
{
public:
  typedef boost::shared_ptr<flex_fir_ff> sptr;
